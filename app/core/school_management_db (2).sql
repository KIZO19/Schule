...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2026 at 12:41 PM
...
INSERT INTO `agents` (`id`, `ecole_id`, `nom`, `postnom`, `prenom`, `telephone`, `role_id`, `salaire_de_base`, `est_enseignant_secondaire`) VALUES
(1, 1, 'Kakule', 'Vianney', 'Jean', '+243990000001', 1, 500.00, 0),
(2, 1, 'Kavugho', 'Sifa', 'Anny', '+243990000002', 2, 450.00, 0),
(3, 1, 'Luvualu', 'Kizombo', 'Joseph', '+243990000003', 5, 400.00, 0),
(4, 1, 'Kambale', 'Mwisa', 'Pascal', '+243990000004', 7, 350.00, 1),
(5, 1, 'Mumbere', 'Kitsali', 'Claude', '+243990000005', 7, 350.00, 1);
...
INSERT INTO `eleves` (`id`, `nom`, `postnom`, `prenom`, `genre`, `lieu_naissance`, `nationalite`, `adresse`, `date_naissance`, `parent_id`, `nom_pere`, `nom_mere`, `province_origine`, `territoire`, `secteur`, `groupement`, `village`, `num_permanent`, `photo`, `statut_eleve`) VALUES
(1, 'Kambale', 'Muhindo', 'Justin', 'M', NULL, 'CONGOLAISE', NULL, '2012-05-14', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'actif'),
(2, 'Paluku', 'Muhindo', 'Arsène', 'M', NULL, 'CONGOLAISE', NULL, '2009-08-22', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'actif'),
(3, 'Masika', 'Kavira', 'Clarisse', 'F', NULL, 'CONGOLAISE', NULL, '2021-02-02', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'actif');
